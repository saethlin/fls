static IMAGE: &[&str] = &[
    "png", "jpeg", "jpg", "gif", "bmp", "tiff", "tif", "ppm", "pgm", "pbm", "pnm",
    "webp", "raw", "arw", "svg", "stl", "eps", "dvi", "ps", "cbr", "jpf", "cbz", "xpm",
    "ico", "cr2", "orf", "nef", "heif",
];

static VIDEO: &[&str] = &[
    "avi", "flv", "m2v", "m4v", "mkv", "mov", "mp4", "mpeg", "mpg", "ogm", "ogv",
    "vo", "wmv", "webm", "m2ts", "heic",
];
...
static COMPRESSED: &[&str] = &[
    ...
    "par", "tgz", "xz", "txz", "lz", "tlz", "lzma", "de", "rpm", "zst",
];
